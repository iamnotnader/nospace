...
public class MutableString {
	private static ArrayList<MutableString> freeQueue = new ArrayList<MutableString>();
	...
	public static MutableString substring(String s, int start, int end)
	{
		MutableString ret = allocateString();
	...
	public static MutableString allocateString()
	{
		if (freeQueue.size() == 0) {
	...
	public static void deallocateString(MutableString s)
	{
		s.length = 0;
		freeQueue.add(s);
	}
	
	public static void deallocateStringHard(MutableString s)
	{
		s.length = 0;
	...
	public boolean equals(Object other){
	    ...
	    MutableString otherStr = (MutableString)other;
